...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/kanish-ai/faketry",
)
...
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/ruy1nl.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/ruy1nl.jpg")
